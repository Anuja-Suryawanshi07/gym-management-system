...
const { getMembers, getMemberById, assignTrainerAndPlan, updateMemberProfile, updateMemberStatus } = require("../controllers/adminController");
...
// PUT /api/admin/users/:id - Update User details (role, email, basic info)
...
// --- TRAINER PROFILE MANAGEMENT (C.R.U.D.) ---
// POST /api/admin/trainers - Create a new Trainer Profile (Standardized to plural '/trainers')
...
// PUT /api/admin/members/:user_id - Update Member Profile details (including plans, trainer, goals)
